...
module.exports.showListing = (async (req, res)=>{
    ...
    if(!mongoose.Types.ObjectId.isValid(id)) {
        return res.status(400).render("error.ejs", {message: "Invalid ID format"});
    }
...
module.exports.createListing = async (req, res, next)=>{
    ...
    newListing.owner = req.user._id; //helps to assign the owner.... the one who has created the listing
